...
histogram_settings = {
    'variables' : {
        ...
        'muon_eta'                 : {'binning' : {'n_or_arr' : 80, 'lo' : -4, 'hi' : 4},    'xlim' : (-4,4),   'xlabel' : "$\eta^{\mu}$"},
        'goodmuon_pt'              : {'binning' : {'n_or_arr' : 200, 'lo' : 0, 'hi' : 2000}, 'xlim' : (0,500),  'xlabel' : "$p_{T}^{\mu}$ [GeV]"},
        'goodmuon_eta'             : {'binning' : {'n_or_arr' : 80, 'lo' : -4, 'hi' : 4},    'xlim' : (-4,4),   'xlabel' : "$\eta^{\mu}$"},
        'electron_pt'              : {'binning' : {'n_or_arr' : 200, 'lo' : 0, 'hi' : 2000}, 'xlim' : (0,500),  'xlabel' : "$p_{T}^{e}$ [GeV]"},
        'electron_eta'             : {'binning' : {'n_or_arr' : 80, 'lo' : -4, 'hi' : 4},    'xlim' : (-4,4),   'xlabel' : "$\eta^{e}$"},
        'goodelectron_pt'          : {'binning' : {'n_or_arr' : 200, 'lo' : 0, 'hi' : 2000}, 'xlim' : (0,500),  'xlabel' : "$p_{T}^{e}$ [GeV]"},
        'goodelectron_eta'         : {'binning' : {'n_or_arr' : 80, 'lo' : -4, 'hi' : 4},    'xlim' : (-4,4),   'xlabel' : "$\eta^{e}$"},
        'jet_pt'                   : {'binning' : {'n_or_arr' : 150, 'lo' : 0, 'hi' : 1500}, 'xlim' : (0,500),  'xlabel' : "$p_{T}^{j}$ [GeV]"},
        'jet_eta'                  : {'binning' : {'n_or_arr' : 80, 'lo' : -4, 'hi' : 4},    'xlim' : (-4,4),   'xlabel' : "$\eta^{j}$"},
        'goodjet_pt'               : {'binning' : {'n_or_arr' : 150, 'lo' : 0, 'hi' : 1500}, 'xlim' : (0,500),  'xlabel' : "$p_{T}^{j}$ [GeV]"},
        'goodjet_eta'              : {'binning' : {'n_or_arr' : 80, 'lo' : -4, 'hi' : 4},    'xlim' : (-4,4),   'xlabel' : "$\eta^{j}$"},
