...
cfg =  {
    ...
    "output"   : "output/sf_ele_trigger_semilep/semileptonic_triggerSF_2018_closuretest",
    "output_triggerSF" : "pocket_coffea/parameters/semileptonic_triggerSF/triggerSF_2018_Ele32_EleHT_closuretest",
    "triggerSF" : None,
    ...
    "weights": {
        "common": {
            ...
            "bycategory" : {
                "Ele32_EleHT_pass_triggerSF" : ["sf_ele_trigger"],
                "Ele32_EleHT_fail_triggerSF" : ["sf_ele_trigger"],
