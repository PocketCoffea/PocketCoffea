...
cfg =  {
    ...
    "categories": {
        ...
        "Ele32_EleHT_pass_lowHT_triggerSF" : [
            get_HLTsel("semileptonic", primaryDatasets=["SingleEle"]),
            get_ht_below(400)
        ],
        "Ele32_EleHT_fail_lowHT_triggerSF" : [
            get_HLTsel("semileptonic", primaryDatasets=["SingleEle"], invert=True),
            get_ht_below(400)
        ],
        "Ele32_EleHT_pass_highHT_triggerSF" : [
            get_HLTsel("semileptonic", primaryDatasets=["SingleEle"]),
            get_ht_above(400)
        ],
        "Ele32_EleHT_fail_highHT_triggerSF" : [
            get_HLTsel("semileptonic", primaryDatasets=["SingleEle"], invert=True),
            get_ht_above(400)
        ],
        "inclusive" : [passthrough],
        "inclusive_triggerSF" : [passthrough],
    },
    ...
    "variables" : {
        **muon_hists(coll="MuonGood", pos=0),
        ...
        "ElectronGood_pt_1_finebinning" : HistConf(
            [
        ...
        "ElectronGood_phi_1_finebinning" : HistConf(
            [
                Axis(coll="ElectronGood", field="phi", pos=0,
                     bins=64, start=-pi, stop=pi,
                     label="Electron $\phi$"),
            ]
        ),
