...
cfg =  {
    ...
    "output"   : "output/datamc/ttHbb_ttbar_ST_WJets_datamc_2017",
    "worflow_options" : {},
        ...
        "weights": {
            "common": {
                "inclusive": [  "pileup",
                                ...
                                "sf_mu_id", "sf_mu_iso", "sf_mu_trigger",
                                "sf_jet_puId"
                              ] + [ f"sf_btag_{b}" for b in btag_variations["2017"]]
                              + [f"sf_ele_trigger_{v}" for v in sf_ele_trigger_variations["2017"]],
                "bycategory" : {
