...
def do_dataset(key, config, local_prefix, allowlist_sites, use_infn, blocklist_sites, regex_sites, **kwargs):
    print("*" * 40)
...
def build_datasets(cfg, keys=None, overwrite=False, download=False, check=False, split_by_year=False, local_prefix=None,
                   allowlist_sites=None, use_infn=False, blocklist_sites=None, regex_sites=None, parallelize=4):
