...
### Using Apptainer to run the analysis on the LPC cluster

If you are working on LPC and you will scale your processing on HTCondor, follow this installation
instructions.
