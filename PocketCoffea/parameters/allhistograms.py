...
histogram_settings = {
    'variables' : {
        ...
        'nbjet'                    : {'binning' : {'n_or_arr' : 20, 'lo' : 0, 'hi' : 20},    'xlim' : (0,20),   'xlabel' : "$N_{b-jet}$"},
        'nsv'                      : {'binning' : {'n_or_arr' : 20, 'lo' : 0, 'hi' : 20},    'xlim' : (0,20),   'xlabel' : "$N_{SV}$"},
        'nparton'                  : {'binning' : {'n_or_arr' : 20, 'lo' : 0, 'hi' : 20},    'xlim' : (0,20),   'xlabel' : "$N_{parton}$"},
        'nparton_matched'          : {'binning' : {'n_or_arr' : 20, 'lo' : 0, 'hi' : 20},    'xlim' : (0,20),   'xlabel' : "$N_{parton,matched}$"},
        'nfatjet'                  : {'binning' : {'n_or_arr' : 10, 'lo' : 0, 'hi' : 10},    'xlim' : (0,10),   'xlabel' : "$N_{fatjet}$"},
        'parton_pt'                : {'binning' : {'n_or_arr' : 150, 'lo' : 0, 'hi' : 1500}, 'xlim' : (0,500),  'xlabel' : "$p_{T}^{parton}$ [GeV]"},
        'parton_eta'               : {'binning' : {'n_or_arr' : 80, 'lo' : -4, 'hi' : 4},    'xlim' : (-4,4),   'xlabel' : "$\eta_{parton}$"},
        'parton_phi'               : {'binning' : {'n_or_arr' : 128, 'lo' : -pi, 'hi' : pi}, 'xlim' : (-pi,pi), 'xlabel' : "$\phi_{parton}$"},
        'parton_dRMatchedJet'      : {'binning' : {'n_or_arr' : 200, 'lo' : 0, 'hi' : 5},    'xlim' : (0,1),    'xlabel' : r'min ${\Delta}R_{parton,jet}$'},
        'parton_pdgId'             : {'binning' : {'n_or_arr' : 50, 'lo' : -25, 'hi' : 25},  'xlim' : (0,1),    'xlabel' : r'Parton pdgId'},
        ...
        'leadfatjet_mass'          : {'binning' : {'n_or_arr' : 200, 'lo' : 0, 'hi' : 1000}, 'xlim' : (0,300),  'xlabel' : "FatJet mass"},
        'leadfatjet_msoftdrop'     : {'binning' : {'n_or_arr' : 200, 'lo' : 0, 'hi' : 1000}, 'xlim' : (0,300),  'xlabel' : "FatJet $m_{SD}$"},
        'leadfatjet_pt'            : {'binning' : {'n_or_arr' : 200, 'lo' : 0, 'hi' : 1000}, 'xlim' : (0,1000), 'xlabel' : "FatJet $p_T$"},
        'leadfatjet_eta'           : {'binning' : {'n_or_arr' : 80, 'lo' : -4, 'hi' : 4},    'xlim' : (-4,4),   'xlabel' : "FatJet $\eta$"},
        'leadfatjet_phi'           : {'binning' : {'n_or_arr' : 128, 'lo' : -pi, 'hi' : pi}, 'xlim' : (-pi,pi), 'xlabel' : "FatJet $\phi$"},
        'leadfatjet_rho'           : {'binning' : {'n_or_arr' : 800, 'lo' : -8, 'hi' : 0},   'xlim' : (-7,0),   'xlabel' : r'FatJet $\rho$'},
        'leadfatjet_Hbb'           : {'binning' : {'n_or_arr' : 50, 'lo' : 0, 'hi' : 1},     'xlim' : (0,1),    'xlabel' : r'btagDDBvL'},
        'leadfatjet_tau21'         : {'binning' : {'n_or_arr' : 80, 'lo' : 0, 'hi' : 1},     'xlim' : (0,1),    'xlabel' : r'FatJet $\tau_{21}$'},
        'leadfatjet_btagDDBvLV2'   : {'binning' : {'n_or_arr' : 80, 'lo' : 0, 'hi' : 1},     'xlim' : (0,1),    'xlabel' : r'FatJet btagDDBvLV2'},
        'leadfatjet_btagDDCvLV2'   : {'binning' : {'n_or_arr' : 80, 'lo' : 0, 'hi' : 1},     'xlim' : (0,1),    'xlabel' : r'FatJet btagDDCvLV2'},
        'leadfatjet_btagDDCvBV2'   : {'binning' : {'n_or_arr' : 80, 'lo' : 0, 'hi' : 1},     'xlim' : (0,1),    'xlabel' : r'FatJet btagDDCvBV2'},
        'leadfatjet_particleNetMD_Xbb' : {'binning' : {'n_or_arr' : 80, 'lo' : 0, 'hi' : 1},     'xlim' : (0,1),    'xlabel' : r'FatJet particleNetMD_Xbb'},
        'leadfatjet_particleNetMD_Xcc' : {'binning' : {'n_or_arr' : 80, 'lo' : 0, 'hi' : 1},     'xlim' : (0,1),    'xlabel' : r'FatJet particleNetMD_Xcc'},
        'leadfatjet_particleNetMD_Xbb_QCD' : {'binning' : {'n_or_arr' : 80, 'lo' : 0, 'hi' : 1},     'xlim' : (0,1),    'xlabel' : r'FatJet particleNetMD Xbb/(Xbb + QCD)'},
        'leadfatjet_particleNetMD_Xcc_QCD' : {'binning' : {'n_or_arr' : 80, 'lo' : 0, 'hi' : 1},     'xlim' : (0,1),    'xlabel' : r'FatJet particleNetMD Xcc/(Xcc + QCD)'},
        'sv_summass'               : {'binning' : {'n_or_arr' : 1000, 'lo' : 0, 'hi' : 1000},'xlim' : (0,500),  'xlabel' : r"FatJet $\sum({m_{SV}})$ [GeV]"},
        'sv_logsummass'            : {'binning' : {'n_or_arr' : 240, 'lo' : -6, 'hi' : 6},   'xlim' : (-2.5,6), 'xlabel' : r"FatJet log($\sum({m_{SV}})$) [GeV]"},
        'sv_projmass'              : {'binning' : {'n_or_arr' : 1000, 'lo' : 0, 'hi' : 1000},'xlim' : (0,500),  'xlabel' : r"FatJet $m_{SV}^{proj}$ [GeV]"},
        'sv_logprojmass'           : {'binning' : {'n_or_arr' : 240, 'lo' : -6, 'hi' : 6},   'xlim' : (-2.5,6), 'xlabel' : r"FatJet log($m_{SV}^{proj}$) [GeV]"},
        'sv_sv1mass'               : {'binning' : {'n_or_arr' : 1000, 'lo' : 0, 'hi' : 1000},'xlim' : (0,1000), 'xlabel' : r"FatJet $m_{SV,1}$ [GeV]"},
        'sv_logsv1mass'            : {'binning' : {'n_or_arr' : 240, 'lo' : -6, 'hi' : 6},   'xlim' : (-4,4),   'xlabel' : r"FatJet log($m_{SV,1}$/GeV)"},
        'sv_sumcorrmass'           : {'binning' : {'n_or_arr' : 1000, 'lo' : 0, 'hi' : 1000},'xlim' : (0,500),  'xlabel' : r"FatJet $\sum({m^{corr}_{SV}})$ [GeV]"},
        'sv_logsumcorrmass'        : {'binning' : {'n_or_arr' : 240, 'lo' : -6, 'hi' : 6}, 'xlim' : (-2.5,6),   'xlabel' : r"FatJet log($\sum({m^{corr}_{SV}})$) [GeV]"},
