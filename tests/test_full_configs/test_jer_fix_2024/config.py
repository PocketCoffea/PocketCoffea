# Before/after comparison of the JER gen-matching fix (docs/jerc_chain_comparison.md)
# on one 2024 data sample and one 2024 ttbar MC sample. See README.md.
...
pt_bins = [20, 25, 30, 35, 40, 50, 60, 80, 100, 150, 200, 300, 500]
eta_bins = [-5.0, -3.0, -2.5, -1.3, 0.0, 1.3, 2.5, 3.0, 5.0]
